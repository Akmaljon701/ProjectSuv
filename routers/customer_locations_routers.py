...
def get_customers(search: str = None, id: int = 0, page: int = 0, limit: int = 25, status: bool = None, db: Session = Depends(database),
    ...
    return all_customer_locations(search, page, limit, db)
